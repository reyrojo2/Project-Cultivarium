...
export default class UIScene extends Phaser.Scene {
  ...
  createCollapsiblePanel(x, y, width, height, side, colors, bgColor) {
    ...
    // Creamos la máscara con this.make.graphics para que no se añada al display list
    // y evitar que tape visualmente a los botones aun cuando es «invisible».
    const maskShape = this.make.graphics({ x: 0, y: 0, add: false });
    maskShape.fillStyle(0xffffff, 1).fillRect(0, 0, width, height);
