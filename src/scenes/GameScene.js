...
export default class GameScene extends Phaser.Scene {
  ...
  createAlertMarker(alert, pos) {
    ...
    const container = this.add.container(pos.x, pos.y - 110);
    ...
    // Relleno generoso y puntero alto para que los mensajes sean legibles a simple vista.
    const padX = 32;
    const padY = 22;
    ...
    const redraw = (message, targetPos) => {
      if (targetPos) {
        container.setPosition(targetPos.x, targetPos.y - 110);
